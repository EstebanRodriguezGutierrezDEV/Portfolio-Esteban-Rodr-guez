export const translations = {
    es: {
        ...
        "experience.title": "Experiencia",
        "experience.job3.title": "Desarrollador de Software",
        "experience.job3.company": "Honeywell",
        "experience.job3.date": "2026",
        "experience.job3.description": "Desarrollo de aplicaciones internas corporativas en una multinacional líder en tecnología industrial, utilizando C# y ASP.NET Core (.NET 8) bajo arquitectura por capas (Controller–Service–Repository) con SQL Server y Entity Framework. Implementé un sistema de reportes de revisión de instalaciones integrado de forma bidireccional con un calendario de eventos, y reforcé la seguridad de la aplicación auditando y blindando múltiples endpoints frente a accesos no autorizados. Además, desarrollé desde cero un chatbot de IA generativa Text-to-SQL 100% local con Ollama, configurando yo mismo el servidor Ubuntu y garantizando que los datos nunca salen de la red interna, junto a un panel de aprendizaje con visión por computador para analizar diagramas y búsqueda semántica mediante embeddings vectoriales.",
    },
    en: {
        ...
        "experience.title": "Experience",
        "experience.job3.title": "Software Developer",
        "experience.job3.company": "Honeywell",
        "experience.job3.date": "2026",
        "experience.job3.description": "Development of internal corporate applications at a multinational leader in industrial technology, using C# and ASP.NET Core (.NET 8) under a layered architecture (Controller–Service–Repository) with SQL Server and Entity Framework. I implemented a facility review reporting system integrated bidirectionally with an event calendar, and strengthened the application's security by auditing and hardening multiple endpoints against unauthorized access. Additionally, I built a fully local generative AI Text-to-SQL chatbot from scratch with Ollama, configuring the Ubuntu server myself and ensuring that data never leaves the internal network, along with a learning panel using computer vision to analyze diagrams and semantic search through vector embeddings.",
    },
};
